...
function generateRecommendations() {
    ...
    if (age === "18-25" && risk === "High") {
        recommendations.push("Young Comprehensive Plan");
    }
    if (coverage === "Premium") {
        recommendations.push("Elite Protection Package");
    }
    if (risk === "Low") {
        recommendations.push("Standard Secure Plan");
    }

    var resultDiv = document.getElementById("recommendation-results");
    resultDiv.innerHTML = "<h3>Recommended Insurance Plans:</h3>";
    ...
    if (recommendations.length > 0) {
        ...
        resultDiv.innerHTML += "<p>No matching insurance plan found. Please refine your preferences.</p>";
    }
}
