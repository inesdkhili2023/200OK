...
export class TowingService {
  private apiUrl = 'http://localhost:8081/api/towings';
  private agentsUrl = 'http://localhost:8081/api/towings/agents';  // ✅ Fixed Agent API Endpoint
  private usersUrl = 'http://localhost:8081/api/towings/users';    // ✅ Fixed User API Endpoint
